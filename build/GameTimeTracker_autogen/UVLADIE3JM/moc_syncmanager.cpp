...
void SyncManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->syncCompleted((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->syncFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->gameEventSynced((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 4: _t->heartbeatSent((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 5: _t->doSync(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)()>(_a, &SyncManager::syncStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)(int , int )>(_a, &SyncManager::syncCompleted, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)(const QString & )>(_a, &SyncManager::syncFailed, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)(const QString & , bool )>(_a, &SyncManager::gameEventSynced, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncManager::*)(bool )>(_a, &SyncManager::heartbeatSent, 4))
            return;
    }
}
...
// SIGNAL 1
void SyncManager::syncCompleted(int _t1, int _t2)
{
...
// SIGNAL 3
void SyncManager::gameEventSynced(const QString & _t1, bool _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 3, nullptr, _t1, _t2);
}

// SIGNAL 4
void SyncManager::heartbeatSent(bool _t1)
{
